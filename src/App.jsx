...
function App() {
  ...
  const transactions = [
    ...
    { id: 15, merchant: 'Ines Ehlerts', amount: +1050.00, date: '2026-07-08', category: 'Income', type: 'card' },
    { id: 9, merchant: 'SB Tankstelle', amount: -142.23, date: '2026-07-06', category: 'Transport', type: 'card' },
    { id: 15, merchant: 'Ines Ehlerts', amount: +150.00, date: '2026-07-06', category: 'Income', type: 'card' },
  ]
      ...
      <div className="transaction-flow">
        ...
        <div className="flow-summary">
          <div className="flow-card incoming">
            ...
            <div className="flow-amount positive">+kr 1.400,00</div>
            <p>This month</p>
          </div>
          <div className="flow-card outgoing">
            ...
            <div className="flow-amount negative">-kr 337,00</div>
            <p>This month</p>
          </div>
        </div>
      </div>
